...
import { addDoctorHandler, getAllDoctorsHAndler, loginAdminHandler, logoutAdminHandler } from "../controllers/admin.controllers.js";
...
route.get("/doctors", [isAuthenticated, authorizedRoles("admin")], getAllDoctorsHAndler);
route.patch("/doctors", [isAuthenticated, authorizedRoles("admin")], updateAvailability);
