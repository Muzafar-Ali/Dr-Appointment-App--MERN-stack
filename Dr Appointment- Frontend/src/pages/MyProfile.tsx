...
const MyProfile = () => {
  ...
  return (
    <div className="max-w-lg flex flex-col gap-2 text-sm">
      ...
      <div>
        { isEditing 
            ? <button onClick={() => setIsEditing(false)} className="border border-primary_base px-8 py-2 rounded-full hover:bg-primary_base hover:text-white transition-all duration-300">Save information</button>
